...
report_timing -path full -delay max -nworst 1 -max_paths 1 \
    -significant_digits 4 -sort_by group > ../syn/PE_ori_timing_max_rpt.txt

report_timing -path full -delay min -nworst 1 -max_paths 1 \
    -significant_digits 4 -sort_by group > ../syn/PE_ori_timing_min_rpt.txt

report_area -nosplit > ../syn/PE_ori_area_rpt.txt

report_power -analysis_effort low > ../syn/PE_ori_power_rpt.txt
